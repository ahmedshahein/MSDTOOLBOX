...
sdm_data    = load('iPatterns/OSR64_3bit_250MHz.txt');

% Design input parameters
Fs          = 250e6;        % Sampling frequency
OSR         = 64;           % Over Sampling Frequency
Fsignal     = 0.48828e6;          % Input signal frequency

delta_F     = 0.05;         % Transition bandwidth = (cutoff band-pass band)/cutoff band
rp_tune     = [0.00001 0.0001 0.0005 0.001 0.005 0.01 0.1];        % Passband ripples
rc_tune     = [0.00001 0.0001 0.0005 0.001 0.005 0.01 0.1];        % Cutoff suppression
...
N_vector = [1 2];
deviation_values = [[6 7 8 9 10 12 13 14 15]; [3 4 5 6 7 8 9 10 12]; [0.5 0.7 0.8 1 1.5 2 4 5 10]];
...
mixed_filter_coefficients = [coeff_matrix(7,4:length(coeff_matrix)); coeff_matrix(12, 4:length(coeff_matrix)); coeff_matrix(30, 4:length(coeff_matrix))];
